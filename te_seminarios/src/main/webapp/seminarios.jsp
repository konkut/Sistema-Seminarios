            ...
            <div class="row bg-dark">
                <div class="col-12">
                    <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
                        ...
                        <a class="btn btn-primary btn-sm" href="seminarioControlador?action=insert"><i class="fa-solid fa-cart-plus"></i>Nuevo</a>
                        <table class="table table-striped">
                            <tr>
                                <td class="text-primary">Id</td>
                                <td class="text-primary">Titulo</td>
                                <td class="text-primary">Fecha</td>
                                <td class="text-primary">Cupo</td>
                                <td></td>
                                <td></td>
                            </tr>
                            <c:forEach var="item" items="${listaSem}">
                                <tr>
                                    ...
                                    <td class="text-white-50">${item.titulo}</td>
                                    <td class="text-white-50">${item.fecha}</td>
                                    <td class="text-white-50">${item.cupo}</td>
                                    <td><a href="seminarioControlador?action=update&id=${item.id}" Target="_self" ><i class="fa-solid fa-file-pen"></i></a></td>
                                    <td><a href="seminarioControlador?action=delete&id=${item.id}" onclick="return(confirm('Estas seguro???'))"><i class="fa-solid fa-trash"></i></a></td> 
                                </tr>
                            </c:forEach>
                        </table>
                    </div> 
